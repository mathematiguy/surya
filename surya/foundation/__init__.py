...
class LogitPredictor(FoundationPredictor):
    """
    Subclass of FoundationPredictor that captures raw logits during inference.
    Overrides process_outputs to store raw logits on the output, and overrides
    prediction_loop to collect and return them.
    """
